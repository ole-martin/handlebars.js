...
export function template(templateSpec, env) {
  ...
  ret._setup = function(options) {
    if (!options.partial) {
      container.helpers = Utils.extend(Object.create(null), env.helpers, options.helpers);

      if (templateSpec.usePartial) {
        container.partials = Utils.extend(Object.create(null), env.partials, options.partials);
      }
      if (templateSpec.usePartial || templateSpec.useDecorators) {
        container.decorators = Utils.extend(Object.create(null), env.decorators, options.decorators);
      }
